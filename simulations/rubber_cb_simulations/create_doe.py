...
def get_data_samples(input_dim=3,
    ...
    sampler = qmc.Sobol(d=input_dim, scramble=True, seed=1)
...
if __name__ == '__main__':
    ...
    input_dataframe.to_csv('doe_vf20.csv', index=True)
    # input_dataframe.to_csv('doe_shear_test_vf20.csv', index=True)
    # input_dataframe.to_csv('doe_uniaxial_test_vf20.csv', index=True)
