...
class HollowPlate:
    """A hollow circle inside a square. One material."""
...
class HeterHollowPlate:
    """multiple hollow cirlce inside a square. A material"""
...
class CircleInclusion:
    """2d composite rve with circle fibers, 2 materials"""
...
class FullCircleInclusion:
    ...
    def __init__(
        ...
        # define the reinforcement information
        self.loc = loc_info["location_information"]
        self.length = loc_info["length"]
        self.width = loc_info["width"]
        # specify the names of simulation
        self.model_name = model_name
        self.part_name = part_name
        self.instance_name = instance_name
