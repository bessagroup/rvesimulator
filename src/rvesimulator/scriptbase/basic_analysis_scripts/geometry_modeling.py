...
class MultiCirclesInclusion: 
    ...
    def create_part(self):
        ...
        self.part = self.model.Part(name='Final_Stuff',
        ...
        t = self.part.MakeSketchTransform(
        ...
        self.part.projectReferencesOntoSketch(sketch=sketch, filter=COPLANAR_EDGES)
        ...
        self.part.PartitionFaceBySketch(faces=faces[:], sketch=sketch)
